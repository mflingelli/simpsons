...
\begin{itemize}
  ...
  \item Clancy Wiggum behauptet, seine Frau Sarah kennengernt zu haben, indem er ihr Drogen zusteckte. Dies steht im Widerspruch zur späteren Episode \glqq Die weiblichen Verdächtigen\grqq\ (siehe \ref{QABF10})
\end{itemize}
}
...
\begin{itemize}
  ...
  \item Die Befragung von Sideshow Mel durch Moe ist eine Anspielung auf die Columbo-Krimireihe.
...
\notiz{Die beiden schweizerischen Illustratorinnen Katrin von Niederhäusern und Janine Wiget gestalteten den Eröffungs-Gag. Die beiden Zürcherinnen hatten 2019 einen viralen Hit kreiert. Sie stellten eine Szene aus der Folge \glqq Lisa hat den Blues\grqq\ (siehe \ref{XABF11}) in grossartiger Detailverliebtheit nach \cite{TB21}.}
...
\notiz{
\begin{itemize}
  \item Dr. Hibbert prakiziert auch im Springfield Medical Center.
  ...
  \item Diese Episode ist dem ehemaligen Animator Edwin E. Aguilar gewidment, der am 11. April 2021 verstorben ist.
\end{itemize}
}

\subsection{Die Königin der Staaten}
Die Simpsons wollen für Lisa ein Geburtagsgeschenk im Zauberladen besorgen. Der Ladenbesitzer will für die Simpsons die Tarotkarten legen und mehr über ihre Zukunft erzählen. Lisa wird, nachdem sie sich gegen den Willen ihrer Mutter geweigert hatte, das College zu besuchen, US-Präsidentin, Homer hört auf zu trinken, Bart führt ein zivilisiertes Leben. Wegen der Weigerung stimmt die Chemie zwischen Marge und Lisa lange Zeit nicht mehr. Letztlich ist Marge dennoch stolz auf ihre Tochter.
