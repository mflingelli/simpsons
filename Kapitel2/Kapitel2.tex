...
\begin{itemize}
	...
	\item Covercraft besteht aus Apu (Gesang), Dr. Hibbert (Schlagzeug), Referent Lovejoy (Gitarre), Homer (Bass) und Kirk van Houten (Keyboard und Tamburin).
\end{itemize}
}

\subsection{Der Mann, der als Dinner kam}
...
\subsection{Barts neuer bester Freund}
...
Die Helloween-Folge besteht aus drei Geschichten:
\begin{itemize}
	\item \textbf{Schule ist die Hölle}\\ Bart entdeckt auf einem der Pulte in der Grundschule zufällig ein Portal zur Hölle und entdeckt, dass es dort eine Schule gibt. Ihm gefällt es dort so gut, dass er auf die Schule gehen will. Nachdem Marge und Homer zugestimmt haben. wird Bart dort ein guter Schüler und macht seinen Abschluss.
...
\begin{itemize}
	...
	\item Weitere Mitglieder der Gruppe \glqq Fett ist fabelhaft\grqq sind u.a. Roy Snyder, der Comic-Buchverkäufer und Küchenhilfe Doris.
...
\subsection{Ein Herz und eine Krone}
...
\begin{itemize}
	...
	\item Springfield feiert das 50-jährige Jubiläum des Springfielder Schritfzuges.
\end{itemize}
}
...
\subsection{Das Schweigen der Rowdys}
