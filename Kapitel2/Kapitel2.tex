...
\begin{itemize}
	...
	\item Lisas Katze Schneeball I wurde überfahren.
\end{itemize}
}
...
\begin{itemize}
	...
	\item \textbf{Albtraum in Evergreen Terrace}\\  Nach einem Unfall mit dem Heizungskessel schwört Hausmeister Willie sterbend, sich an den Springfielder Kindern zu rächen und zwar in ihren Träumen.
...
\begin{itemize}
  ...
  \item  \textbf{Haarig und schleimig}\\ Selma findet endlich die große Liebe: Kodos, den Zerstörer, der von Mr. Burns im Atomkraftwerk gefangen gehalten wird. Dieser scheint 2der perfekte Partner für sie zu sein.
\end{itemize}
...
\subsection{Das perfekte Dinner}
...
\begin{itemize}
  ...
  \item \textbf{Der vierte Donnerstag nach morgen}\\ Statt Marge soll sich eine Küche mit künstlicher Intelligenz um das diesjährige Thanksgiving-Menü kümmern. Doch die KI entwickelt schnell ein gefährliches Eigenleben.
...
\notiz{Diese Episode ist meiner Laufzeit von 24 Minuten und 52 Sekunden die bisher längste Einzelepisode der Simpsons.}
...
\subsection{Mensch gegen Maschine}
...
\begin{itemize}
  ...
  \item In der neuen Schule empfiehlt der Alogrithmus den hochbegabten Schülern \glqq Programmierung in C+++\grqq. Hier ist auch ein Lehrer zu sehen, der seinen Schülern die Riemannsche Vermutung\index{Riemannsche Vermutung}\footnote{Die Riemannsche Vermutung oder Riemannsche Hypothese ist eine Annahme über die Nullstellen der Riemannschen Zetafunktion. Das Institut in Cambridge (Massachusetts) hat ein Preisgeld von einer Million US-Dollar für eine schlüssige Lösung des Problems in Form eines mathematischen Beweises ausgelobt.} erklärt.
\end{itemize}}

\subsection{Frinkcoin}
...
\begin{itemize}
  ...
  \item Gemäß dieser Episode basiere die Sicherheit aller Kryptowähren auf der Sicherheit des Hash-Verfahrens SHA-256\index{SHA-256}. Die Software-Entwickler, die an Burns Kryptowährung arbeiten, schätzen, dass sie 90.000 Jahre brauchen, um die Unsicherheit von SHA-256 zu beweisen.
\end{itemize}}
...
\subsection{Bildschirmlos}
Marge ist der Ansicht, dass die gesamte Familie viel zu viel Zeit vor dem Bildschirm verbringt. Sie entscheidet sich für eine radikale Methode und reduziert die Zeit, die jeder vor dem Screen verbringen darf, radikal ein. Leider muss sie feststellen, dass ausgerechnet sie mit dem Verzicht überhaupt nicht zurechtkommt, und besteht darauf, dass sich die Familie einem Entzugsprogramm stellt. 