...
\notiz{Sarah Wiggum war Mitglied einer Diebesbande, die von Lindsey Naegle angeführt wurde.}

\subsection{Saures oder Zeitschleife}
Ganz Springfield wählt einen neuen Präsidenten. Nur Homer fehlt. Er ist in der Hängematte eingeschlafen, was schwerwiegende Folgen für den Wahlausgang hat.
\begin{itemize}
  \item \textbf{Toy Gory}\\ Bart geht mit seiner neuen Radioactive Man Figur nicht behutsam um. Als Strafe erwachen alle seine Spielzeuge zum Leben und wollen Bart töten.
  \item \textbf{Into the Homerverse}\\ Homer zerstört das Raum-Zeit-Kontinuum. Dadurch sieht sich Springfield plötzlich mit vielen Homers aus verschiedenen Paralleluniversen bedroht.
  \item \textbf{Be Nine, Rewind}\\ Lisa stirbt durch ein Unglück an ihrem neunten Geburtstag, wird aber direkt wieder lebendig und hat die Chance den Lauf der Dinge zu verändern. Allerdings bringt sie damit ihre Familie und Freunde in Gefahr.
\end{itemize}
