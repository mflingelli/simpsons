...
\subsection{Die weiblichen Verdächtigen}
Da Homer im letzten Moment abgesagt hat, muss Marge die Kinder auf einen Schulausflug begleiten. Dabei landet sie ausgerechnet in der Gruppe der nicht gerade mitteilsamen Sarah Wiggum, mit der zunächst Konversation möglich ist. Aber dann, als die beiden Mütter gemeinsam Nachtwache halten müssen, kommt Sarah langsam aus der Reserve und die beiden Frauen werden Freundinnen, wodurch Marge, von Sarahs schockierenden Geheimnis erfährt. 