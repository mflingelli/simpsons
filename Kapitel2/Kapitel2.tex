...
Die Helloween-Folge besteht aus drei Geschichten:
\begin{itemize}
	\item \textbf{School is hell}\\ Bart entdeckt auf einem der Pulte in der Grundschule zufällig ein Portal zur Hölle und entdeckt, dass es dort eine Schule gibt. Ihm gefällt es dort so gut, dass er auf die Schule gehen will. Nachdem Marge und Homer zugestimmt haben wird Bart dort ein guter Schüler und macht seinen Abschluss.
	\item \textbf{A Clockwork Yellow}\\ Die Erlebnisse von Moe und seiner Gang erinnern an Stanley Kubricks Klassiker \glqq Uhrwerk Orange\grqq .
	\item \textbf{The Others}\\ Im Haus der Simpsons spukt es. Wie sich herausstellt, handelt es sich bei den Geistern um ihre eigenen Ebenbilder aus der Vergangenheit.
\end{itemize}
