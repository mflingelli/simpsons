...
\begin{itemize}
  \item \textbf{Danger Things}\\ Bart, Milhouse und Nelson machen sich in einer \glqq Stranger Things\grqq-Parodie auf die Suche nach ihrem Freunde Milhouse. Dieser wird in einer anderen Dimension gefangen gehalten.
  \item \textbf{Heaven Swipes Right}\\ Homer stirbt, wird aber zurück auf die Erde geschickt und kann fortan in einem anderen Körper weiterleben. Er entscheidet sich für einen Footballspieler und versucht Marges Herz erneut zu gewinnen.
  \item  \textbf{When Hairy Met Slimy}\\ Selma findet endlich die große Liebe: Ein Alien, das im Keller ihres Hauses lebt, scheint zunächst der perfekte Partner für sie zu sein. Dann jedoch droht ihm Gefahr von Mr. Burns.
\end{itemize}
