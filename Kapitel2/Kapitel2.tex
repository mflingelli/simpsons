...
\begin{itemize}
  ...
  \item Die Webseite der \glqq Legitimate Businessmen's Club Security Film\grqq\ lautet \href{http://www.lbcsf.com/videos}{www.lbcsf.com/videos}.
\end{itemize}
}

\subsection{Episode 666}
...
\begin{itemize}
  ...
  \item  \textbf{Haaring und schleimig}\\ Selma findet endlich die große Liebe: Kodos, den Zerstörer, der von Mr. Burns im Atomkraftwerk gefangen gehalten wird. Dieser scheint 2der perfekte Partner für sie zu sein.
\end{itemize}

\notiz{Unter den Kandidaten, die Homer auswählen darf, befindet sich auch Prof. Farnsworth\index{Farnsworth} aus der Serie \glqq Futurama\grqq\index{Futurama}.}

\subsection{Gorilla Ahoi!}
...
\begin{itemize}
  ...
  \item Ned Flanders, Willie, Nelson und Herman nehmen am Springfielder Timbersports-Wettkampf teil.
  \item Der Jeff Albertson ist oft in Portland, um sich zu erholen.
\end{itemize}
}