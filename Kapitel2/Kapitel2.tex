...
\subsection{Grauer Dunst}
Als die Simpsons bei der Geburtstagsfeier von Marges Mutter erfahren, dass Pattys und Selmas Vater an Lungenkrebs gestorben ist, beschließen die beiden leidenschaftlichen Nikotin-Schwestern, dem Rauchen abzuschwören. Doch dann findet Patty heraus, dass Selma heimlich weiterraucht; sie ist schwer enttäuscht und zieht vorübergehend bei Homer und Marge ein.

\notiz{
\begin{itemize}
	\item Disco Stu hat ein Profil auf Tinder.
\end{itemize}
}