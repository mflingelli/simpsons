...
\notiz{
\begin{itemize}
  \item Rod Flanders trägt im Team die Nummer 66, sein Bruder Todd die 6. Als Homer ver\-kün\-det, dass Bart der Quarterback der Wildcats ist, stehen die Flanders-Jungs nebeneinander und so ergibt sich 666, die Zahl des Teufels.
...
Nach einem Streich von Bart ist Rektor Skinner überfordert und Oberschulrat Chalmers über\-nimmt persönlich Barts Unterricht. Er versucht durch die Geschichte von Teddy Roosevelt, Barts Interesse zu erwecken und dies mit großem Erfolg. Allerding wird Chalmers entlassen. Bart erreicht aber seine Wiedereinstellung als Oberschulrat.
...
\begin{itemize}
  \item \textbf{Barti}\\ In einer Parodie auf den Film \glqq Bambi\grqq, werden Bart und seine Mutter von dem Jäger Mr. Burns verfolgt. Marge stirbt dabei und Bart schwört blutige Rache.
  \item \textbf{Diesseits von Parasite von Bong Joon-Ho}\\ Angelehnt an den südkoreanischen Film \glqq Parasite\grqq, wird Bart Simpson der Nachhilfelehrer von Rainer Wolfcastles Tochter Greta und zieht in die Villa des Filmstars ein. Auch Kirk van Houten arbeitet für den Hollywood-Star. Als dieser jedoch mit Kirk nicht mehr zufrieden ist, schlägt Bart vor stattdessen seine Familie einzustellen. Doch was geschah mit den Van Houtens eigentlich?
  ...
  \item \textbf{Der verräterische Bart}\\ Ein Erzähler liest Maggie das Buch \glqq The Telltale Bart\grqq\ vor. Darein wird beschrieben, wie Barts Unfug von Monat zu Monat schlimmer wird.
  \item \textbf{Bei Anruf Tod}\\ Eine Parodie auf den Horrorfilm \glqq The Ring\grqq : Die Kinder aus Springfield veranstalten eine Party und laden Lisa Simpson nicht ein. Später erfährt sie, dass dort alle ein mysteriöses Video angeschaut haben und innerhalb einer Woche danach auf seltsame Art und Weise verstarben. Lisa will der Sache selber auf den Grund gehen und geht auf die Suche nach Mopey Mary, dem Mädchen aus dem Video.
\end{itemize}