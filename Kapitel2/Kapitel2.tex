...
Als Otto, der Schulbusfahrer, plötzlich spurlos verschwindet, steht die Grundschule von Springfield ohne Fahrer da. Die verzweifelten Eltern bringen ihre Kinder selbst zur Schule, was ein chaotisches Verkehrsaufkommen verursacht, das die Schülerlotsen nicht mehr bewältigen können. Auf der Suche nach Verstärkung stößt das Team schließlich auf Homer, der sich eher unfreiwillig dazu meldet. Doch seine Einheit, die ursprünglich für die Sicherheit der Kinder im Straßenverkehr sorgen sollte, erhält so umfangreiche finanzielle Unterstützung, dass sie sich bald in eine gefürchtete Gesetzeshüter-Gang verwandelt.
...
Marge ist zutiefst enttäuscht, als sie an ihrem Geburtstag von ihren Kindern lediglich billige Werbegeschenke erhält. Um ihre Mutter aufzuheitern, fassen Lisa und Bart den Entschluss, sie mit etwas Besonderem zu überraschen. Bei ihren Nachforschungen entdecken sie, dass Marge in ihrer Jugend einen Papagei hatte, der ihr engster Freund war. Die beiden Geschwister setzen ihren detektivischen Spürsinn ein und spüren den Vogel auf, um ihn Marge stolz als Geburtstagsgeschenk zu überreichen. Doch zu ihrer Überraschung reagiert Marge auf das Präsent eher zurückhaltend. Währenddessen macht Homer in der Nachbarschaft als übertriebener Panikmacher auf sich aufmerksam.
...
Um Kosten zu senken, plant Mr. Burns, ausschließlich Arbeiter einzustellen, die keiner Gewerkschaft angehören. Doch bevor er dies umsetzen kann, schmiedet er einen perfiden Plan, um die gewerkschaftlich organisierten Mitarbeiter loszuwerden. Er inszeniert einen groß angelegten Stromausfall und macht Homer dafür verantwortlich. Verzweifelt versucht Homer, seine Unschuld zu beweisen, doch die Bewohner von Springfield schenken ihm keinen Glauben. Selbst Marge fällt es schwer, ihm zu vertrauen.
...
Bart hat während des Nachsitzens eine enge Freundschaft mit Hausmeister Willie aufgebaut. Eines Tages wird Willie nach Schottland entführt, und Bart überredet seine Familie, ihm zu helfen. In Edinburgh angekommen, entdecken sie, dass Willie nicht entführt wurde, sondern auf seine Jugendliebe Maisie gestoßen ist, die er heiraten möchte. Während Homer, der Hochzeiten im Ausland auf den Tod nicht ausstehen kann, sich mit Marge in einen Streit verwickelt, wird Bart misstrauisch und erkennt, dass die Familie der Braut dunkle Absichten verfolgt.
...
\subsection{Do The Wrong Thing}\label{35ABF01}
Grampa, der seit zwanzig Jahren als Angel-Champion von Springfield ungeschlagen ist, wünscht sich, dass Homer sein Erbe als Meisterangler antritt. Obwohl Homer keinerlei Talent fürs Angeln hat, gelingt es ihm überraschenderweise, den Angelwettbewerb von Springfield zu gewinnen. Der Grund: Bart hatte heimlich Murmeln in den gefangenen Fisch geschmuggelt, um das nötige Gewicht auf der Waage zu erreichen. Von nun an schummeln sich Vater und Sohn gemeinsam durch mehrere Wettbewerbe -- und gehen jedes Mal als Sieger hervor. Währenddessen bewirbt sich Lisa ehrgeizig für ein Sommer-Camp an der Universität.
...
\notiz{Prof. Frink, Lenny, Carl und Barney haben einen Emmy gewonnen.}

\subsection{Lisa bleibt auf der Strecke}
Lisa wird von starken Angstzuständen geplagt, deren Ursache die Psychiaterin bald aufdeckt: Panikattacken, die Lisa jedes Mal erleidet, wenn sie mit Homer im Auto unterwegs ist. Um Lisa zu helfen, entwickelt die Therapeutin eine ungewöhnliche Idee. Sie meldet Lisa bei einem Go-Kart-Rennen an, damit sie am Steuer lernt, ihre Ängste zu überwinden. Schon bald avanciert Lisa zu einer der erfolgreichsten Fahrerinnen der Kinder-Formel-1.

\notiz{Homers Alptraum zeigt die Figuren als Parodien auf die Fahrer der Videospielserie Mario Kart, die auf der Rainbow-Road-Strecke ein Rennen fahren. Lisa, Homer, Milhouse, Nelson, Ralph und Sherri oder Terri werden als Mario, Wario, Yoshi, Bowser, Toad bzw. Prinzessin Peach dargestellt.}
...
\notiz{
\begin{itemize}
  \item Marge ist Mitglied im Elternbeirat der Grundschule von Springfield.
  \item Die Ice-Age-Szenen wurden im Stil der Zeichentrickserie Primal\index{Primal} gezeichnet. Der Schöpfer dieser Serie, Genndy Tartakovsky\index{Tartakovsky!Genndy}, würdigte die Hommage auf Instagram und antwortete mit einer Zeichnung von Homer im Primal-Stil.
\end{itemize}
}

\subsection{Ein Mops kam in die Küche}\label{35ABF07}
Lisas Katze Schneeball verletzt das Huhn eines kleinen Mädchens schwer. Die Tierarztkosten für das Federvieh übersteigen das Budget der Simpsons jedoch bei Weitem, sodass Marge beschließt, als Köchin bei dem Lieferservice Gimme Chow\index{Gimme Chow} anzuheuern. Da sie abends arbeiten muss, stellt sie die Bedingung, dass der Rest der Familie jeden Abend gemeinsam kocht. Die Familie lässt sich allerdings lieber Essen liefern und zwar von Marges Arbeitgeber. Doch schon bald artet ihr neuer Job in viel Stress aus. Daher will sie eine Gewerkschaft gründen. Doch was ihr daraufhin widerfährt, hätte sie wohl nicht erwartet.

\notiz{
\begin{itemize}
  \item Gil Gunderson ist der Restaurantleiter der Springfielder Niederlassung von Gimme Chow.
  \item Die Küchenszene ist eine Parodie auf eine ähnliche Szene aus der Episode \glqq Review\grqq\ der Fernsehserie \glqq The Bear\grqq. Außerdem verschüttet Marge einen Eimer \glqq Mayo Edebiri\grqq, eine Anspielung auf den \glqq The Bear\grqq-Star Ayo Edebiri\index{Edebiri!Ayo}.
\end{itemize}
}

\subsection{Fünf Amigos!}\label{35ABF09}
Larry, ein Stammgast der Bar, der jedoch nie besonders aufgefallen ist, stirbt. Moe, Homer, Lenny und Carl fühlen sich dazu verpflichtet, auf die Beerdigung zu gehen. Dort erfahren sie von seiner Mutter, dass sie, obwohl sie nie mit ihm gesprochen haben, für Larry sehr wichtig waren. Zudem vererbt sie ihnen ein Buch ihres Sohnes, in dem ein Bild seines \glqq Lieblingsortes\grqq, den Serenity-Wasserfällen, zu sehen ist. Die Männer beschließen, Larry dort die letzte Ehre zu erweisen.

\notiz{
\begin{itemize}
  \item Larry heißt eigentlich Lawrence Dalrymple\index{Dalrymple!Lawrence}.
  \item Larry war leidenschaftlicher Angler.
  \item Hank Azaria wurde für seine Leistung als Moe Szyslak in dieser Folge bei den 76. Primetime Creative Arts Emmy Awards für den Primetime Emmy Award for Outstanding Character Voice-Over Performance nominiert.
  \item Der Autor John Frink wurde für den Writers Guild of America Award for Television bei den 77th Writers Guild of America Awards für sein Drehbuch zu dieser Folge nominiert.
\end{itemize}
}

\subsection{Diamantenfieber}
Marge fühlt sich von ihrer Familie nicht ausreichend wertgeschätzt. Kurzerhand verkauft sie heimlich Homers alte Jeans für über 2.500 Dollar und plant, das Geld ausschließlich für sich selbst zu nutzen. Trotz anfänglicher Bedenken gönnt sie sich einen Diamantring. Doch schon bald plagt sie das schlechte Gewissen, und sie versteckt das Schmuckstück. Als Homer den Ring entdeckt, reagiert er enttäuscht und verärgert.

\notiz{
\begin{itemize}
  \item Homers Hose ist eine Levi's 501, wobei Levi's wie folgt geschrieben ist: Leevi's\index{Leevi's}. Die Hose hat damit einen Wert laut der Fernsehsendung \glqq Trash for Ca\$h von mindestens 2.600 US\$.
  \item Mr. Burns bespricht mit Smithers den Film Oppenheimer\index{Oppenheimer} aus dem Jahr 2023 als Inspiration für den Bau eines Atommeilers und ist überrascht zu erfahren, dass am selben Tag ein anderer Film in die Kinos kam, ein Hinweis auf das kulturelle Phänomen Barbenheimer\index{Barbenheimer}.
\end{itemize}
}

\subsection{Der Rest ist für Sie}
Während eines Restaurantbesuchs macht Homer einen Fehler und schreibt in die Trinkgeldzeile einen Betrag, der so interpretiert wird, als hätte er 10.000 Dollar Trinkgeld gegeben. Anfangs versucht er, den Irrtum zu korrigieren, doch als er sieht, wie viel Anerkennung ihm dafür entgegengebracht wird, lässt er den Betrag stehen. Begeistert von der Wertschätzung beginnt Homer, regelmäßig großzügige Trinkgelder zu geben, da er sich dadurch von der Gesellschaft zunehmend respektiert fühlt. Dies hat jedoch ernste Konsequenzen, und die Simpsons geraten schließlich an den Rand des finanziellen Ruins.

\notiz{Homer performt eine Parodie des Songs \glqq Planet of the Bass\grqq, in der Gordon und Poland ihre Rollen aus dem Musikvideo wieder aufnehmen und in der auch Trullinger auftritt.}

\subsection{Barts Gehirn}\label{35ABF12}
Bart verkauft Grampas alte Militärgegenstände und nutzt das Geld, um ein menschliches Gehirn in einem Glas zu erwerben. Er plant, es für einen seiner größten Streiche an der Schule einzusetzen -- und der Plan gelingt ihm. Doch anstatt ihn wie erwartet zu bestrafen, beauftragt Miss Peyton Bart überraschenderweise damit, auf das Gehirn aufzupassen. Nach und nach entwickelt Bart eine ungewöhnlich enge Beziehung zu dem seltsamen Objekt und nennt es schließlich seinen besten Freund.

\notiz{
\begin{itemize}
  \item Barney ist auf Platz eins der Liste für Lebertransplantationen.
  \item Der Knochen in Mels Haaren ist ein Oberschenkelknochen eines Kängurus.
  \item Die Schlussszene, in der Bart das Gehirn zurückbringt, ist eine Parodie auf das Ende des Films Furious 7 aus dem Jahr 2015, einschließlich des Songs \glqq See You Again\grqq\ aus dem Soundtrack des Films, der im Hintergrund läuft.
\end{itemize}
}

\section{Staffel 36}

\subsection{Barts Geburtstag}
In der vermeintlich letzten Episode der Simpsons, die von einer KI namens HackGPT geschrieben wurde, feiert Bart seinen 11. Geburtstag. Doch als er die Einladungen zu seiner Party verteilt, stellt er fest, dass Springfield sich radikal verändern wird: Skinner und Willie ziehen weg, Homer tötet Mr. Burns auf der Arbeit und Krusty nimmt die letzte Episode seiner Sendung auf. Bart entwickelt plötzlich ein eigenes Bewusstsein und stemmt sich gegen die Veränderungen und das von der KI produzierte Ende.

\subsection{Yellow Lotus}
Die Simpsons haben vor Jahren einen Timesharing-Vertrag für das Luxus-Resort \glqq The Yellow Lotus\grqq\ abgeschlossen und wollen nun ihre Punkte einlösen. Zu ihrer Überraschung reicht das Guthaben jedoch nur für einen 20-minütigen Aufenthalt. Bart findet jedoch einen Weg, um länger zu bleiben. Während ihres Aufenthalts kommt es zu unheimlichen Ereignissen, die möglicherweise mit ihrem Erzfeind Tingeltangel-Bob in Verbindung stehen.

\subsection{Lisa verzweifelt gesucht}
Lisa verbringt ein Wochenende mit ihren Tanten Patty und Selma in Capital City, wo sie in die hippe Kunstszene eintaucht und von ambitionierten Künstlern umgeben ist, die ihr einen Platz auf einer elitären Kunstschule versprechen. Doch bald merkt sie, dass sie einem Betrug aufsitzt und sich in einer wilden Verfolgungsjagd durch die Metropole wiederfindet.

\subsection{Zwei in einem Sarg}
Als bei der Räumung des Friedhofs Shady Oaks\index{Shady Oaks} ein Sarg mit zwei Leichen entdeckt wird und eine Visitenkarte von Grampa Simpson zum Vorschein kommt, wird er als Zeuge befragt. Es stellt sich heraus, dass Grampa vor Jahren eine Privatdetektei betrieb und einen mysteriösen Fall um seinen verschwundenen Partner nicht aufklärte. Die Ermittlungen deuten darauf hin, dass Mr. Burns in die Sache verwickelt ist.

\subsection{Der Wunschknochen}
\begin{itemize}
	\item \textbf{The Information Rage}\\
	Die Anschaffung von LED-Lampen sorgt für eine tiefe Spaltung in der Bevölkerung von Simpsons. Nachdem die Bewohner rebellieren, tauchen ein Rotes und ein Blaues Monster auf, die niemals einer Meinung sein können.
	\item \textbf{The Fall of the House of Monty}\\
	Mr. Burns verspricht etwas, was er nicht halten kann. Kurz darauf bricht ein tödlicher Fluch über seiner Fabrik herein, der seine Fabrik in eine Todesfalle verwandelt. Der Fluch kann nur aufgehoben werden, wenn Burns sein Versprechen hält.
	\item \textbf{Denim}\\
	Homer findet die perfekte Jeans für seine Körperform. Doch schon bald entwickelt diese ein Eigenleben und wird zur echten Bedrohung für alle. Die Hose entwickelt allerdings ein Eigenleben: Es handelt sich um Denim\index{Denim}, einen Außerirdischen vom Planeten Wrang-ler\index{Wrang-ler}. Mit der Jeans erlangt Homer besondere Fähigkeiten.
\end{itemize}

\subsection{Ladies Night}
Es geht es um verschiedene Kurzgeschichten, die den Alltag der Frauen in Springfield zeigen. Patty und Selma starten eine verzweifelte Suchaktion nach ihren Zigaretten, während Malibu Stacy ihre Plastikwelt verlässt, um ein besonderes Mädchen zu treffen. Marge schickt Homer los, um ein Tabu zu brechen, was zu lustigen Situationen führt. Weitere Szenen zeigen Nelsons Mutter im Alltag und ein Date zwischen Julius und Bernice Hibbert.

\subsection{Die Nacht der lebenden Simpsons}
Die Simpsons besuchen den \glqq R. Bradybury's Traveling Night Circus\grqq, wo Lisa einem tätowierten Mann begegnet, dessen Tattoos drei Horrorgeschichten erzählen:
\begin{itemize}
	\item \textbf{The Screaming Woman}\\
	Bart hört im Wald eine Frau unter der Erde schreien, doch seine Eltern glauben ihm nicht. Seine Suche führt ihn in eine grausige Geschichte, die sich bei den Van Houtens abgespielt haben muss.
	\item \textbf{Marionettes, Inc.}\\
	Oberschuldirektor Chalmers will Rektor Skinner durch einen Roboter ersetzen, doch dieser hat einen ähnlichen Plan.
	\item \textbf{Fahrenheit 451}\\
	In einem dystopischen Springfield werden Bücher verbrannt und anspruchslose Unterhaltung ist strikt verboten. Homer will nicht länger mitmachen.
\end{itemize}

\subsection{Con Air}
Die Simpsons müssen mit \glqq Convenience Airways\grqq\ fliegen, weil Homer bei allen anderen Airlines gesperrt ist. Diese Fluggesellschaft ist bekannt dafür, Passagiere zu befördern, die anderswo nicht mehr mitfliegen dürfen. Marge bekommt ein Upgrade in die erste Klasse und genießt den Luxus, während Homer in der Economy-Class mit anderen Passagieren aneinandergerät. Die Geschichte wird in einem Gerichtsprozess erzählt, bei dem Marge und Homer ihre chaotische Flugreise Revue passieren lassen. Der Flug zum Bouvier-Familientreffen wird zur Katastrophe, als Homer mit einem nervigen Comic Book Guy und anderen skurrilen Passagieren konfrontiert wird. Nachdem Maggie einen Wutanfall bekommt, muss Homer sie durch das Flugzeug tragen, um ihre Windel zu wechseln. Dabei entdecken sie einen geheimen Gefängnisbereich unter dem Flugzeug, in dem unliebsame Passagiere landen. Durch eine unerwartete Wendung gelingt es Homer jedoch, die Situation zu retten, indem er den anderen Passagieren zeigt, dass sie sich wie zivilisierte Menschen verhalten sollten.

\subsection{Homer und seine Schwestern}
Krustys Tante Sadie erkennt, dass er arrogant gegenüber seinen Mitarbeitern ist, was ihn einsam macht. Daraufhin startet die neue Show \glqq Das Problem bist du\grqq, in der Sadie mit ihrer Analyse zwischenmenschliche Konflikte löst. Marge meldet sich mit ihrem Problem an - Homer, Patty und Selma liegen im Clinch.
Der Streit zwischen Homer, Patty und Selma eskaliert an deren Geburtstag im Fun Once Escape Room. Homer verschwendet zwei Tipps, was zu einem Streit führt. Marge versucht zu vermitteln, aber alte Wunden brechen auf. Zur gleichen Zeit besucht Tante Sadie Krusty, um an Sideshow Mels Podcast teilzunehmen.

\subsection{Der Berg ruft}
Das Bowlingteam \glqq Pin Pals\grqq\ um Homer, Carl, Ned Flanders und Fausto stürzt auf dem Weg zur Staatsmeisterschaft mit einem überladenen Helikopter in den Bergen ab. Während die Stadtbewohner die Hoffnung aufgeben, bleibt Marge optimistisch. Die Gruppe kämpft ums Überleben, Fausto stirbt, und sie leiden an Hunger und Halluzinationen. Moe zerstört das einzige funktionierende Telefon, was die Lage verschärft. Doch Homer findet neue Kraft, als er Marge' Kochkünste riecht, und führt die Gruppe sicher zurück nach Springfield, wo sie als Helden gefeiert werden.

\subsection{Flasche leer}
Mr. Smithers soll für Mr. Burns eine wertvolle, angeblich von Napoleon stammende Weinflasche liefern. Homer hilft bei der Lieferung und bringt die Flasche nach Hause, wo Marge sie versehentlich in einem Rindfleischeintopf verkocht. Um den Verlust zu vertuschen, hilft Professor Frink bei der Herstellung einer perfekten Kopie des Weins, die bei einer Verkostung von Mr. Burns' Wine Club für echt befunden wird. Marge und Smithers planen, eine weitere Flasche des nachgemachten Weins zu verkaufen und den Erlös für wohltätige Zwecke zu spenden, doch ihr Plan fliegt auf und sie werden vor das Weingericht von Springfield gestellt.

\subsection{Flanders' Liste}
Homer bemerkt, dass DJs viel Geld verdienen können, und überredet Bart, eine DJ-Karriere zu starten. Doch die lauten Nächte führen zu einem Streit mit dem Nachbarn Ned Flanders, der schließlich beschließt, nicht mehr mit Homer zu sprechen. Nach Monaten des Schweigens eskaliert die Situation und landet vor Gericht. Die beiden werden zu einer Paartherapie verurteilt, bei der sie eine psychedelische Droge einnehmen und in einer gemeinsamen Halluzination ihre Beziehung aufarbeiten. Schließlich erkennen sie, dass sie trotz ihrer Differenzen aufeinander angewiesen sind und finden zur Versöhnung zurück.

\subsection{Durch dick und dünn}
In Moe's Bar fällt auf, dass Barney fehlt. Als er hereinkommt, ist er überraschend dünn und erzählt, dass er wegen seiner Hyperglykämie das Medikament Othinquic\index{Othinquic} nimmt, das seinen Appetit unterdrückt und Gewichtsverlust als Nebenwirkung hat. Die Nachricht verbreitet sich schnell in Springfield, und bald nehmen alle übergewichtigen Einwohner das Mittel -- außer Homer. Als Marge ihn jedoch dazu ermutigt, willigt Homer ein, es auszuprobieren. Doch Marge bemerkt bald, dass das Medikament nicht nur das Gewicht, sondern auch die Lebensfreude raubt.

\subsection{P.S. Ich hasse dich}
Marge wird beim Einkauf in einem Billigladen bloßgestellt und verliert kurz darauf ihre geheimen Hassbriefe, mit denen sie ihre Wut verarbeitet. Als ein Erpresser 5.000 Dollar für die Rückgabe der Briefe fordert, entdeckt Marge, dass ihre \glqq Freundin\grqq\ Shauna\index{Shauna} dahintersteckt, die Marges verletzende Briefe als perfekte Waffe gegen sie verwendet.

\subsection{Feld der Träume}
Grampa Abe Simpson und Moe freunden sich im Baseballstadion an. Gemeinsam überzeugen sie den mazedonischen Baseballspieler Walkov\index{Walkov}, nach Springfield zu kommen, was den Isotopes eine Siegesserie beschert. Doch der Erfolg führt zu einer übermäßigen Kommerzialisierung des Vereins, was Grampa zutiefst enttäuscht. Als Moe herausfindet, dass Walkov illegale Wetten annimmt, muss Grampa helfen, die Situation zu bereinigen.

\subsection{Ein Mob kam in die Küche}
Bart und Lisa liefern sich nach einem Streit um den Vordersitz einen monatelangen Nachahmungskrieg. Letztendlich findet Lisa eine Lösung, indem sie Bart in ihre Aktivitäten einbezieht und ihre Geschwisterbande stärkt.
Parallel dazu entwickelt Homer eine Obsession für den Food-Challenge-Star Thad Parkour\index{Parkour!Thad}, der in Springfield bei einer Fleischbällchen-Challenge zusammenbricht. Als Thad ein geheimes Mafia-Rezept von Fat Tony stiehlt, um es im Fernsehen zu präsentieren, fürchtet Homer die Rache der Mafia.

\subsection{Volles Herz und leerer Pool}
Homer versucht, einen Pool in seinem Garten zu bauen, verursacht jedoch Chaos und gewinnt daraufhin eine Klage gegen den Baumarkt, bei dem er Poolnudeln und Bälle kauft. Seine Frau Marge sorgt sich um sein Vermächtnis, was Homer verzweifeln lässt. Er findet Trost bei seinem Vater Grampa, und gemeinsam erfinden sie das Spiel \glqq Noodleball\index{Noodleball}\grqq, das in leeren Schwimmbecken gespielt wird.
Das Spiel wird schnell beliebt bei Senioren in Springfield, aber als ein Konzern Interesse an der Sportart zeigt, muss Homer eine schwierige Entscheidung treffen. Der Konzern will Noodleball als Sport für die Reichen vermarkten, was bedeutet, dass Grampa aus dem Projekt ausgeschlossen werden müsste. Homer entscheidet sich zunächst dafür, um sein eigenes Vermächtnis zu sichern, merkt aber bald, dass er einen Fehler gemacht hat. Letztendlich scheitert das Noodleball-Projekt, als Homer und Grampa sich bei einem Turnier verletzen, aber die beiden können ihre Beziehung kitten. 

\subsection{Was vom Tage übrig blieb}
Bart und Lisa schauen jeden Tag gemeinsam \glqq Itchy \& Scratchy\grqq. Als sie eines Tages feststellen, dass sie zu alt für die Serie sind, befürchtet Marge, dass ihre Kinder sich irgendwann voneinander entfernen. Eindringlich beschwört sie die beiden, immer zueinanderzuhalten. Ein Blick in die Zukunft zeigt jedoch, dass ihr Wunsch nicht in Erfüllung geht: Während Lisa als Präsidentin der Frauen-Basketballliga in der großen weiten Welt etabliert ist, ist Bart ein drogenabhängiger Betrüger, der ein illegales Altersheim betreibt. Als Lisa für eine Rede nach Springfield zurückkehrt, kommt es zu einem Wiedersehen mit alten Bekannten und trotz aller Differenzen versöhnt sie sich am Ende ein Stück weit mit der Familie.