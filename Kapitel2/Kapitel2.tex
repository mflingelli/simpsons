...
\begin{itemize}
  ...
  \item Bart legt beim Srabble das Wort Kwyjibo\index{Kwyjibo}. Laut ihm bezeichnet es \glqq einen dicken, fetten, blöden, nordamerikanischen Affen, der die Haare verliert\dots\grqq\ und  Marge ergänzt: \glqq \dots und schnell die Geduld.\grqq  
\end{itemize}
}
...
\notiz{
\begin{itemize}
  \item Der Fockusgruppe gehören Marge, Helen, Bernice, Agnes und Julio an.
...
\begin{itemize}
  ...
  \item Bart auf seiner Ablagebank beim Scrabbel das Wort Kwyjibo\index{Kwyjibo} liegen -- wie bereits in Folge \glqq Bart wird ein Genie\grqq\ (siehe \ref{7G02}).
...
\begin{itemize}
  ...
  \item An der Wall of Fame im Bowl-A-Rama hängen u.\,a. Fotos von Homer, Barney und Jaques.
...
\subsection{Pädagogische Ansichten eines Clowns}
...
\subsection{Homers Abenteuer durch die Windschutzscheibe}
...
\begin{itemize}
  ...
  \item In der Hölle kann der Streamdienst Hellflix\index{Hellflix} empfangen werden.
