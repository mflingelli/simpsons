...
\begin{itemize}
  \item \textbf{A-Gobble-Ypto}\\ Die Simpsons sind eine Truthahn-Familie, die von den Pilgervätern gnadenlos gejagt werden. Bei dem Versuch Maggie zu retten wird Truthahn Homer von Wiggum gefangen genommen.
  \item \textbf{The Fourth Thursday After Tomorrow}\\ Statt Marge soll sich eine Küche mit künstlicher Intelligenz um das diesjährige Thanksgiving-Menü kümmern. Doch die KI entwickelt schnell ein gefährliches Eigenleben.
  \item  \textbf{The Last Thanksgiving}\\ Bart und Milhouse gehören zu den letzten Menschen, die auf einem Raumschiff in eine neue Welt fliegen. Als sie aus dem Hyperschlaf erweckt werden, beschließt Bart, ein große Party an Bord zu schmeißen. Doch durch einen Unfall schaffen sie ein unglaubliches Monster.
\end{itemize}