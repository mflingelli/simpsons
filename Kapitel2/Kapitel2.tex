...
\begin{itemize}
  \item \textbf{Intrusion of the Pod-y Switchers}\\ 
  \item \textbf{Multiplisa-ty}\\ 
  \item  \textbf{Geriatric Park}\\ Mr. Burns startet sein spezielles Altersheim \glqq Geratirc Park\grqq\ auf einer geheimen Insel. Um den Heimbewohnen ein besserers Leben zu ermöglichen, wurde mit Dinosaurier DNA experimentiert. Schon kurze Zeit später ergeben sich daraus ungeahnte Folgen.
\end{itemize}
