...
Schnuffi, der Hamster von Lisa, taucht in zwei Episoden auf. Lisa Simpson verglich ihn in der Folge \glqq Die Geburtstagssüberraschung\grqq\ (siehe \ref{7F24}) dabei für ein Schulexperiment die Intelligenz ihres Hamsters Schnuffi mit der ihres Bruders Bart. Ihr Bruder schnitt bei diesem Test schlecht ab. Seinen zweiten Auftritt hat er in der Folge \glqq Der eingebildete Dachdecker\grqq\ (siehe \ref{GABF10}), in welcher er die von Homer errichtete Wasserleitung hinunterrutscht und durch den Briefschlitz auf die Straße hinausgespült wird.
