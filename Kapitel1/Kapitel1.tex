...
Lindsey Naegle ist eine Finanzplanerin (\glqq Homer und das Geschenk der Würde\grqq, \ref{CABF04}), Werbeberaterin und Mobiltelefon\-ver\-käuf\-er\-in, die in manchen Episoden auftritt. Sie ist Single und versucht dies manchmal mit sehr drastischen Mitteln zu ändern, eine Anspielung auf \glqq Sex and the City\grqq . Ihre zeitweilige Kollegin, ärgste Konkurrentin bei der Partnersuche und trotz allem wohl beste Freundin ist Cookie Kwan. Sie fährt sein grünen VW Käfer, wie in der Episode \glqq Vergiss-Marge-Nicht\grqq\ (siehe \ref{KABF02}) zu sehen ist.
