...
\begin{description}
  ...
  \item[Tomacco] Es handelt sich hier um eine Züchtung aus Tomate und Tabakpflanze, die mittels nuklearer Energie entstand und der Familie Simpson zu einer Plantage verhalf (siehe \glqq Duell bei Sonnenaufgang\grqq, \ref{AABF19}). Ein Fan der gelben Familie war von dieser Idee so angetan, dass er nur vier Jahr später seine eigene Tomacco züchtete. Die Macher der Simpsons fühlten sich so geschmeichelt, dass sie seine Kreation sogar probierten.
...
YABF17 & Das perfekte Dinner & 12.10.2020\\
       & Thanksgiving Of Horro & 24.11.2019\\
\hline
...
\hline
Carl Carlson & Hank Azaria & Klaus Kessler (Staffel 4)\\
             &             & Peter Musäus (ab Staffel 5)\\
\hline
