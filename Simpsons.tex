...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Werbegags
	\end{itemize}
	\item Ergänzungen in folgenden Abschnitten: \ref{JasperBeardsley}, \ref{HerkunftNamen}, \ref{7F22}, \ref{8F01}, \ref{8F03}, \ref{8F04}, \ref{8F16}, \ref{9F15}, \ref{9F16}, \ref{3F09}, \ref{3F17}, \ref{5F01}, \ref{5F03}, \ref{5F08}, \ref{AABF03}, \ref{AABF05}, \ref{AABF06}, \ref{AABF07}, \ref{AABF08}, \ref{HABF03}, \ref{StaffelUebersicht}, \ref{ItchyAndScratchy} und \ref{Auszeichnungen}.
\end{itemize}
