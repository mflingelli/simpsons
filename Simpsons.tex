...
\vspace*{8cm}
\begin{flushleft}
  \Huge\textcolor{white}{\textbf{\sffamily Hier sind die Simpsons}}\\
  \textcolor{white}{\rule{\linewidth}{4pt}}
  \vspace{2ex}
  \huge\textcolor{white}{\textbf{\sffamily 10. überarbeitete Ausgabe}}
\end{flushleft}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Werbegags
	\end{itemize}
	\item Ergänzungen in folgenden Abschnitten: \ref{SimpsonsIT}, \ref{ItchyAndScratchy} und \ref{Synchronsprecher}.
\end{itemize}
