...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Werbegags
	\end{itemize}
	\item Ergänzungen in folgenden Abschnitten: \ref{CarlCarlson}, \ref{7G02}, \ref{7G12}, \ref{BABF10}, \ref{ElizabethHoover}, \ref{GilGunderson}, \ref{ItchyAndScratchy} und \ref{Auszeichnungen}.
\end{itemize}
