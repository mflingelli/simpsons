...
\begin{flushleft}
  ...
  \vspace{2ex}
  \huge\textcolor{blue}{\textbf{\sffamily 10. überarbeitete Ausgabe}}
\end{flushleft}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Werbegags
	\end{itemize}
	\item Ergänzungen in folgenden Abschnitten: \ref{Charaktere}, \ref{SimpsonsIT}, \ref{ItchyAndScratchy} und \ref{Synchronsprecher}.
\end{itemize}
