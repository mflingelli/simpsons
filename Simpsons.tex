...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Gaststars
		\item Werbegags
		\item Ergänzungen in folgenden Abschnitten: \ref{Charaktere}, \ref{Tatum}, \ref{7F13}, \ref{7F20}, \ref{8F03}, \ref{8F04}, \ref{RABF11}, \ref{SABF01}, \ref{TABF03} und \ref{Synchronsprecher}.
	\end{itemize}
\end{itemize}
