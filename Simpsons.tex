...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Werbegags
	\end{itemize}
	\item Ergänzungen in folgenden Abschnitten: \ref{Charaktere}, \ref{CMBurns}, \ref{GaryChalmers}, \ref{JimboJones}, \ref{KearneyZzyzwicz}, \ref{DolphStarbeam}, \ref{WendellQueasly}, \ref{HerschelKrustofski}, \ref{Hummelmann}, \ref{JeffAlbertson}, \ref{HansMaulwurf}, \ref{SimpsonsMathematik}, \ref{Werbegags}, \ref{ItchyAndScratchy}, \ref{Synchronsprecher} und \ref{Auszeichnungen}.
\end{itemize}
