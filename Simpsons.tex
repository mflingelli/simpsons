...
\newcommand{\staffelAnzahl}{26}
\newcommand{\episodenAnzahl}{574}
...
\begin{flushleft}
  ...
  \rule{\linewidth}{5pt}
  \vspace{1ex}
  \large\textbf{\sffamily 9. überarbeitete Ausgabe}
\end{flushleft}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Werbegags
	\end{itemize}
	\item Ergänzungen in folgenden Abschnitten: \ref{HomerSimpson}, \ref{BartSimpson}, \ref{MonaSimpson}, \ref{GaryChalmers}, \ref{JuliusHibbert}, \ref{ApuNahasapeemapetilon}, \ref{TimothyLovejoy}, \ref{KirkVanHouten}, \ref{MoeSzyslak} und\ref{Synchronsprecher}
\end{itemize}
