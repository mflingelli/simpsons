...
\newcommand{\staffelAnzahl}{24}
\newcommand{\episodenAnzahl}{530}
...
\begin{flushleft}
  ...
  \rule{\linewidth}{5pt}
  \vspace{1ex}
  \large\textbf{\sffamily 7. überarbeitete Ausgabe}
\end{flushleft}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Werbegags
	\end{itemize}
	\item Ergänzungen in folgenden Abschnitten: \ref{MoeSzyslak}, \ref{HermanHermann}, \ref{8F08}, \ref{8F09}, \ref{8F16} und \ref{Auszeichnungen}.
\end{itemize}
