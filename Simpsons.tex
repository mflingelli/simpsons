...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Werbegags
	\end{itemize}
	\item Ergänzungen in folgenden Abschnitten: \ref{JasperBeardsley}, \ref{7F22}, \ref{8F01}, \ref{8F03}, \ref{8F04}, \ref{8F16},  \ref{3F09}, \ref{3F17}, \ref{5F01}, \ref{5F03}, \ref{5F08}, \ref{HABF03}, \ref{ItchyAndScratchy} und \ref{Auszeichnungen}.
\end{itemize}
