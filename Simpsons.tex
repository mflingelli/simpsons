...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Gaststars
		\item Werbegags
		\item Ergänzungen in folgenden Abschnitten: \ref{Charaktere}, \ref{ApuNahasapeemapetilon}, \ref{Tatum}, \ref{7F13}, \ref{7F14}, \ref{7F20}, \ref{7F22}, \ref{8F03}, \ref{8F04}, \ref{2F02}, \ref{EABF07}, \ref{RABF11}, \ref{SABF01}, \ref{TABF03}, \ref{TABF09}, \ref{VABF03}, \ref{Vorhersagen} und \ref{Synchronsprecher}.
	\end{itemize}
\end{itemize}
