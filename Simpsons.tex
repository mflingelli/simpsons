...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Werbegags
	\end{itemize}
	\item Ergänzungen in folgenden Abschnitten: \ref{Charaktere}, \ref{OttoMan}, \ref{Willie}, \ref{ApuNahasapeemapetilon}, \ref{HansMaulwurf}, \ref{JohnFrink}, \ref{7F02}, \ref{SimpsonsIT}, \ref{ItchyAndScratchy} und \ref{Synchronsprecher}.
\end{itemize}
