...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Werbegags
	\end{itemize}
	\item Ergänzungen in folgenden Abschnitten: \ref{CMBurns}, \ref{GaryChalmers}, \ref{JimboJones}, \ref{WendellQueasly}, \ref{HerschelKrustofski}, \ref{Hummelmann}, \ref{JeffAlbertson}, \ref{HansMaulwurf}, \ref{Werbegags}, \ref{ItchyAndScratchy} und \ref{Synchronsprecher}.
\end{itemize}
