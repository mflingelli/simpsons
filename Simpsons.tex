...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Werbegags
	\end{itemize}
	\item Ergänzungen in folgenden Abschnitten: \ref{CMBurns}, \ref{WaylonSmithers}, \ref{Willie}, \ref{MelvinVanHorne}, \ref{HoratioMcCallister}, \ref{HansMaulwurf}, \ref{CletusSpuckler}, \ref{JohnFrink}, \ref{7G08}, \ref{8F12}, \ref{2F23}, \ref{CABF04}, \ref{CABF08}, \ref{CABF09}, \ref{FABF10}, \ref{WABF13}, \ref{YABF02}, \ref{SimpsonsIT}, \ref{SimpsonsMathematik} und \ref{Auszeichnungen}.
\end{itemize}
