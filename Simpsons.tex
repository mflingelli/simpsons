...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Gaststars
		\item Werbegags
		\item Ergänzungen in folgenden Abschnitten: \ref{Charaktere}, \ref{WaylonSmithers}, \ref{DolphStarbeam}, \ref{Hummelmann}, \ref{HerkunftNamen}, \ref{7F01}, \ref{7F04}, \ref{7F22}, \ref{8F05}, \ref{8F13}, \ref{9F10}, \ref{9F11}, \ref{9F20}, \ref{1F22}, \ref{2F03}, \ref{2F23}, \ref{3F04}, \ref{3F18}, \ref{5F01}, \ref{5F03}, \ref{5F06}, \ref{BABF21}, \ref{DABF17}, \ref{MABF18}, \ref{NABF17}, \ref{RABF07}, \ref{SABF04}, \ref{SABF03}, \ref{WABF15}, \ref{ZABF09}, \ref{ExistiertSpringfield}, \ref{Vorhersagen} und \ref{Synchronsprecher}.
	\end{itemize}
\end{itemize}
