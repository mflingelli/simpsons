...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Werbegags
	\end{itemize}
	\item Ergänzungen in folgenden Abschnitten: \ref{CarlCarlson}, \ref{ElizabethHoover}, \ref{RainierWolfcastle}, \ref{GilGunderson}, \ref{JohnFrink}, \ref{7G02}, \ref{7G12}, \ref{BABF10}, \ref{ItchyAndScratchy} und \ref{Auszeichnungen}.
\end{itemize}
