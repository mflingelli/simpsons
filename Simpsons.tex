% Den Titel der Helloween-Folge der 13. Staffel überprüfen
...
%\usepackage{rotating}
%\usepackage[bookmarks,colorlinks,bookmarksnumbered,final,backref]{hyperref}
...
\newcommand{\staffelAnzahl}{25}
\newcommand{\episodenAnzahl}{552}
\newcommand{\emmyAnzahl}{27}
...
% \rotatebox{22.5}{\textsf{\textbf{\color{lightgray}Entwurf}}}}}
%  }
%}
}

\title{\LARGE Hier sind die Simpsons}
...
\setcounter{page}{1}      % Das Inhaltsverzeichnis wird römisch numeriert
\pagenumbering{roman}
...
%\fancyfoot[LE,RO]{\bfseries \today}
\fancyfoot[C]{}
%\fancyfoot[RE]{\bfseries Release Candidate}
...
\HTMLOutput{}
{
  ...
  pdfauthor = {\textcopyright\ Markus Flingelli, 2005 - 2014},
...
\begin{flushleft}
  \Huge\textbf{\sffamily Hier sind die Simpsons}\\
  \rule{\linewidth}{5pt}
  \vspace{1ex}
  \large\textbf{\sffamily 8. überarbeitete Ausgabe}
\end{flushleft}

\vspace*{18cm} 

\begin{flushright}
  \large\textbf{\sffamily Markus Flingelli\\}
  \small\sffamily\href{mailto:Markus.Flingelli@gmx.de}{Markus.Flingelli@gmx.de}
\end{flushright}
...
\section*{Vorwort}
In diesem Werk habe ich Informationen rund um die Fernsehfamlie \glqq Die Simpsons\grqq\ zusammengefasst. Diese Zusammenstellung beinhaltet zum einen eine Beschreibung der wichtigsten Charaktere der Serie und eine kurze Zusammenfassung aller \episodenAnzahl\ Folgen der Staffeln 1 bis \staffelAnzahl . Neben der Beschreibung jeder einzelnen Folge werden Hintergrundinformationen zu den Episoden gegeben. Im Anhang befinden sich Listen mit der Staffelübersicht, den Tafelgags, den Gaststars und den Synchronsprechern. Im Anhang wird ferner die oft kontrovers diskutierte Frage beantwortet, in welchem Bundesstaat der USA sich eigentlich die Stadt Springfield, in der die Simpsons leben, befindet. 

Diese Zusammenfassung und die Listen erheben weder den Anspruch auf Voll\-stän\-dig\-keit noch auf Fehlerfreiheit. Sollten Sie Verbesserungsvorschläge oder Er\-gänz\-un\-gen haben, würde ich mich freuen, wenn Sie mir diese mitteilen würden. Wenn Sie Fehler entdecken, wäre ich ebenso für eine Korrektur dankbar.
...
\subsection*{}
\HTMLOutput{
Memmingen, \today , Markus Flingelli
}
{
Memmingen, \today \hfill Markus Flingelli
}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Werbegags
	\end{itemize}
	\item Ergänzungen in folgenden Abschnitten: \ref{Charaktere}, \ref{CMBurns}, \ref{WaylonSmithers}, \ref{GaryChalmers}, \ref{JimboJones}, \ref{KearneyZzyzwicz}, \ref{DolphStarbeam}, \ref{WendellQueasly}, \ref{HerschelKrustofski}, \ref{Hummelmann}, \ref{JeffAlbertson}, \ref{HansMaulwurf}, \ref{SimpsonsMathematik}, \ref{Werbegags}, \ref{ItchyAndScratchy}, \ref{Synchronsprecher} und \ref{Auszeichnungen}.
\end{itemize}
