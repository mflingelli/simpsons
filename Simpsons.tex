...
\newcommand{\staffelAnzahl}{28}
\newcommand{\episodenAnzahl}{617}
...
\begin{flushleft}
  ...
  \vspace{2ex}
  \huge\textcolor{blue}{\textbf{\sffamily 12. überarbeitete Ausgabe (Entwurf)}}
\end{flushleft}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Werbegags
	\end{itemize}
	\item Ergänzungen in folgenden Abschnitten: \ref{AbeSimpson}, \ref{CMBurns}, \ref{LennyLeonard}, \ref{CarlCarlson}, \ref{KentBrockman}, \ref{HerschelKrustofski}, \ref{MelvinVanHorne}, \ref{Lou}, \ref{FatTony}, \ref{GilGunderson}, \ref{KirkVanHouten}, \ref{JohnFrink}, \ref{ReicherTexaner}, \ref{SimpsonsMathematik} und \ref{ItchyAndScratchy}.
\end{itemize}
