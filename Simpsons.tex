...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Werbegags
	\end{itemize}
	\item Ergänzungen in folgenden Abschnitten: \ref{Charaktere}, \ref{Schnuffi}, \ref{KentBrockman}, \ref{7G06}, \ref{7G07}, \ref{7F24}, \ref{8F08}, \ref{8F15}, \ref{8F21}, \ref{9F03}, \ref{2F10}, \ref{ItchyAndScratchy}, \ref{Synchronsprecher} und \ref{Auszeichnungen}.
\end{itemize}
