...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Werbegags
	\end{itemize}
	\item Ergänzungen in folgenden Abschnitten: \ref{AbeSimpson}, \ref{CMBurns}, \ref{LennyLeonard}, \ref{CarlCarlson}, \ref{KentBrockman}, \ref{HerschelKrustofski}, \ref{MelvinVanHorne}, \ref{FatTony}, \ref{GilGunderson}, \ref{KirkVanHouten}, \ref{JohnFrink}, \ref{ReicherTexaner}, \ref{SimpsonsMathematik} und \ref{ItchyAndScratchy}.
\end{itemize}
