...
\documentclass[pagesize,twoside,german]{scrbook}
\makeatletter
...
\newcommand{\staffelAnzahl}{36}
\newcommand{\episodenAnzahl}{790}
\newcommand{\emmyAnzahl}{36}
...
\begin{flushleft}
  ...
  \vspace{2ex}
  \huge\textcolor{blue}{\textbf{\sffamily 19. überarbeitete Ausgabe}}
\end{flushleft}
...
\subsection*{Änderungen zur Ausgabe vom 05.05.2025}
\begin{itemize}
	\item Einarbeiten der 36. Staffel in
	\begin{itemize}
		\item Episodenführer
		...
		\item Werbegags
	\end{itemize}
	\item Ergänzungen in folgenden Abschnitten: \ref{Gaststars:Staffel35}
\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Werbegags
	\end{itemize}
	\item Ergänzungen in folgenden Abschnitten: \ref{AbeSimpson}, \ref{CMBurns}, \ref{MelvinVanHorne} \ref{GilGunderson}, \ref{LawrenceDalrymple}, \ref{UABF19} und \ref{Synchronsprecher}.
\end{itemize}
