...
\begin{flushleft}
  ...
  \vspace{2ex}
  \huge\textcolor{blue}{\textbf{\sffamily 10. überarbeitete Ausgabe (Entwurf)}}
\end{flushleft}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Werbegags
	\end{itemize}
	\item Ergänzungen in folgenden Abschnitten: \ref{Charaktere}, \ref{OttoMan}, \ref{Willie}, \ref{ApuNahasapeemapetilon}, \ref{HansMaulwurf}, \ref{JohnFrink}, \ref{7F02}, \ref{SimpsonsIT}, \ref{ItchyAndScratchy}, \ref{Synchronsprecher} und \ref{Auszeichnungen}.
\end{itemize}
