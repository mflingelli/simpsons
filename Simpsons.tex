...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Gaststars
		\item Werbegags
		\item Ergänzungen in folgenden Abschnitten: \ref{Charaktere}, \ref{CMBurns}, \ref{ApuNahasapeemapetilon}, \ref{CletusSpuckler}, \ref{Snake}, \ref{LionelHutz}, \ref{Tatum}, \ref{7F01}, \ref{7F13}, \ref{7F14}, \ref{7F20}, \ref{7F22}, \ref{8F03}, \ref{8F04}, \ref{1F02}, \ref{1F03}, \ref{1F19}, \ref{2F02}, \ref{5F19}, \ref{5F20}, \ref{5F22}, \ref{AABF03}, \ref{AABF05}, \ref{EABF07}, \ref{PABF20}, \ref{RABF04}, \ref{RABF11}, \ref{SABF01}, \ref{SABF12}, \ref{TABF03}, \ref{TABF09}, \ref{VABF03}, \ref{VABF17}, \ref{YABF18}, \ref{YABF17}, \ref{Vorhersagen} und \ref{Synchronsprecher}.
	\end{itemize}
\end{itemize}
