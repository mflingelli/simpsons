...
\newcommand{\staffelAnzahl}{31}
\newcommand{\episodenAnzahl}{684}
...
\begin{flushleft}
  ...
  \vspace{2ex}
  \huge\textcolor{blue}{\textbf{\sffamily 14. überarbeitete Ausgabe}}
\end{flushleft}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Werbegags
	\end{itemize}
	\item Ergänzungen in folgenden Abschnitten: \ref{MelvinVanHorne}, \ref{HansMaulwurf}, \ref{CletusSpuckler}, \ref{JohnFrink}, \ref{7G08}, \ref{2F23}, \ref{CABF04}, \ref{CABF08}, \ref{CABF09}, \ref{FABF10}, \ref{WABF13}, \ref{YABF02}, \ref{SimpsonsIT}, \ref{SimpsonsMathematik} und \ref{Auszeichnungen}.
\end{itemize}
