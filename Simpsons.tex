...
\newcommand{\staffelAnzahl}{27}
\newcommand{\episodenAnzahl}{596}
...
\begin{flushleft}
  ...
  \rule{\linewidth}{5pt}
  \vspace{1ex}
  \large\textbf{\sffamily 10. überarbeitete Ausgabe}
\end{flushleft}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Werbegags
	\end{itemize}
	\item Ergänzungen in folgenden Abschnitten: \ref{ItchyAndScratchy} und \ref{Synchronsprecher}.
\end{itemize}
